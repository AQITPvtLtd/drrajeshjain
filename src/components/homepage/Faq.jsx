...
const faqs = [
  ...
  { id: 2, question: "When is surgery recommended for cancer?", answer: "Surgery is recommended when the tumor is localized and can be safely removed to cure, control, or reduce cancer." },
...
export default function Faq() {
  const [activeIndex, setActiveIndex] = useState(null); // 🔹 No question open by default
    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 relative">
        ...
        <div className="hidden lg:block">
          <div className="absolute top-1/2 right-6 transform -translate-y-1/2 w-[500px]">
            <div className="relative">
              <div className="absolute inset-0 bg-[#1e3b70] rounded-3xl w-[88%] h-[92%] top-6 left-6 -z-10"></div>
              <Image src="/about/faq.png" alt="Doctor" width={480} height={560} className="rounded-2xl object-contain" />
            </div>
          </div>
        </div>
      </div>
